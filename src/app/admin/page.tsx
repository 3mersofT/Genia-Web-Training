    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="px-6 py-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-500">GENIA Web Training Platform</p>
            </div>
              ...
              <div className="relative">
                ...
                {searchQuery && (
                  <div className="absolute top-full left-0 right-0 bg-white border border-gray-200 rounded-lg shadow-lg mt-1 z-50">
                    <div className="p-2 text-sm text-gray-500 border-b">Résultats de recherche</div>
                    <div className="p-2 hover:bg-gray-50 cursor-pointer">
                      <div className="font-medium">Marie Dupont</div>
                      <div className="text-xs text-gray-500">marie.dupont@entreprise.com • Utilisateur</div>
                    </div>
                    <div className="p-2 hover:bg-gray-50 cursor-pointer">
                      <div className="font-medium">Module 1 - Fondamentaux</div>
                      <div className="text-xs text-gray-500">Contenu • 12 capsules</div>
                    </div>
      ...
      <div className="bg-gray-50 border-b px-6 py-2">
        <nav className="flex items-center space-x-2 text-sm">
          <a href="/" className="text-blue-600 hover:text-blue-700">GENIA</a>
          <span className="text-gray-500">/</span>
          <a href="/admin" className="text-blue-600 hover:text-blue-700">Administration</a>
          <span className="text-gray-500">/</span>
          <span className="text-gray-900 font-medium">Vue d'ensemble</span>
        </nav>
      </div>
      ...
      <div className="bg-white border-b px-6">
        <nav className="flex gap-6">
          ...
          <a
            href="/admin/users"
            className="py-3 px-1 border-b-2 border-transparent font-medium text-sm text-gray-500 hover:text-gray-700 transition-colors"
          >
            <div className="flex items-center gap-2">
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <p className="text-sm text-gray-600 mt-1">Utilisateurs totaux</p>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <p className="text-sm text-gray-600 mt-1">Taux de complétion</p>
                <div className="mt-3">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <p className="text-sm text-gray-600 mt-1">Messages GENIA</p>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="h-32 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-400 mt-1">Données réelles en cours de collecte</p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  {stats.totalUsers === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-xs text-gray-400 mt-1">Les logs d'activité apparaîtront ici</p>
                    </div>
                  ) : (
                    <div className="text-center py-8">
                      <p className="text-gray-500 text-sm">Logs d'activité en cours de développement</p>
                      <p className="text-xs text-gray-400 mt-1">Données réelles bientôt disponibles</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="mt-6 bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-900">Contenu</span>
                </a>
                <a
                  href="/admin/analytics"
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-900">Analytics IA</span>
                </a>
                <a
                  href="/admin/settings"
