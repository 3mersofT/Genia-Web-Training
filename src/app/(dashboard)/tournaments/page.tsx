          ...
          <div>
            ...
            {tournaments.length === 0 ? (
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-700 mb-2">Aucun tournoi disponible</h3>
                <p className="text-gray-500">Les tournois seront affichés ici lorsqu&apos;ils seront disponibles.</p>
              </div>
            ) : (
