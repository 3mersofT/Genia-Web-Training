  ...
  return (
    <div className={`flex gap-2 ${className}`}>
      <textarea
        ...
        disabled={disabled}
        rows={1}
        className="flex-1 px-4 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none overflow-y-auto disabled:opacity-50 disabled:cursor-not-allowed"
