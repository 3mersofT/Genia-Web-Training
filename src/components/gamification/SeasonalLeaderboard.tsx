        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg bg-muted text-foreground hover:bg-accent font-medium flex items-center gap-2 transition-colors"
            >
              Historique
          ...
          {showHistory && (
            ...
            >
              <div className="mt-4 pt-4 border-t">
                <h3 className="text-sm font-semibold text-foreground mb-3">Saisons précédentes</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                  {historicalSeasons.length > 0 ? (
                    historicalSeasons.map((season) => (
                      ...
                      >
                        <div className="font-medium text-foreground text-sm">{season.season_name}</div>
                    ...
                    <p className="text-sm text-muted-foreground col-span-full">Aucune saison historique disponible</p>
                  )}
                </div>
              </div>
            </motion.div>
            ...
            leaderboard.map((entry, index) => (
              ...
              >
                ...
                <div className="md:hidden mt-3 grid grid-cols-4 gap-2 text-center">
                  ...
                  <div>
                    <div className="text-sm font-bold text-green-600 dark:text-green-400">{entry.tournaments_won}</div>
                    <div className="text-xs text-muted-foreground">Tournois</div>
                  </div>
                  <div>
