...
import { getQualityLabel, getQualityColor, type SM2Quality } from '@/lib/services/spacedRepetitionService';
              ...
              <div className="grid grid-cols-3 gap-2">
                {([0, 1, 2, 3, 4, 5] as SM2Quality[]).map((q) => (
                  ...
                  >
                    ...
                    <span className="block text-xs opacity-90">{getQualityLabel(q)}</span>
                  </button>
                ))}
              </div>
            </div>
